 ...
 */
public class AdapterKomisi extends RecyclerView.Adapter<AdapterKomisi.ViewHolder> {

    public static final int HEADER_PAGER = 0;
    public static final int CHILD = 1;
    List<Anggota> data;
    Activity activity;
    boolean isFromKomisi;

    public AdapterKomisi(Activity activity, List<Anggota> data, boolean isFromKomisi) {
        this.data = data;
        this.activity = activity;
        this.isFromKomisi = isFromKomisi;
    }
