...
public class XMLRPCClient {
    ...
    /**
     * With this flag enabled, the {@link de.timroes.axmlrpc.XMLRPCClient} ignores all namespaces
    ...
    public static final int FLAGS_APACHE_WS = FLAGS_IGNORE_NAMESPACES | FLAGS_NIL
            | FLAGS_DEFAULT_TYPE_STRING;
    /**
     * With this flag enabled, the {@link de.timroes.axmlrpc.XMLRPCClient} will use the system http
    ...
    /**
     * Returns a {@link java.util.Map} of all cookies. It contains each cookie key as a map
    ...
    /**
     * Installs a custom {@link javax.net.ssl.TrustManager} to handle SSL/TLS certificate verification.
     ...
     *
     * @param trustManager {@link javax.net.ssl.TrustManager} to install.
    ...
    /**
     * Installs custom {@link javax.net.ssl.TrustManager TrustManagers} to handle SSL/TLS certificate
     * verification. This will replace any previously installed {@code TrustManagers}s.
     * If {@link #FLAGS_SSL_IGNORE_INVALID_CERT} is set, this won't do anything.
     *
     * @param trustManagers {@link javax.net.ssl.TrustManager TrustManagers} to install.
    ...
    /**
     * Installs a custom {@link javax.net.ssl.KeyManager} to handle SSL/TLS certificate verification.
     * This will replace any previously installed {@code KeyManager}s.
     * If {@link #FLAGS_SSL_IGNORE_INVALID_CERT} is set, this won't do anything.
     *
     * @param keyManager {@link javax.net.ssl.KeyManager} to install.
    ...
    /**
     * Installs custom {@link javax.net.ssl.KeyManager KeyManagers} to handle SSL/TLS certificate
     * verification. This will replace any previously installed {@code KeyManagers}s.
     * If {@link #FLAGS_SSL_IGNORE_INVALID_CERT} is set, this won't do anything.
     *
     * @param keyManagers {@link javax.net.ssl.KeyManager KeyManagers} to install.
    ...
    private class Caller extends Thread {
        ...
        public Object call(String methodName, Object[] params) throws XMLRPCException {
            Log.d("params_json", new Gson().toJson(params));
            try {
