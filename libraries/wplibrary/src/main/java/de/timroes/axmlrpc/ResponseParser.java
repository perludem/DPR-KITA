...
class ResponseParser {
    ...
    public Object parse(InputStream response) throws XMLRPCException {
        ...
        try {
            ...
            String modifiedResponse = total.toString().replace("<?xml version=\"1.0\" encoding=\"UTF-8\"?>", "");
            response = new ByteArrayInputStream(modifiedResponse.getBytes("UTF-8"));
            //end modified by ibun
